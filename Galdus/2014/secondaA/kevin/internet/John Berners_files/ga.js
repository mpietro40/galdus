...
<body style="background-color:#000000; font-family:verdana, arial, 'sans serif';">
<div style="width:80%; margin:20px auto;">
    ...
    <div style="padding:20px; margin-top:20px; background-color:#E2E2E2; text-align:center; color:#000000; font-family:verdana, arial, 'sans serif'; font-size:80%;">
      <p style="font-weight:bold; font-size:150%;">Access to the requested page has been denied.</p>
      <p>URL: <a href="http://www.google-analytics.com/ga.js">http://www.google-analytics.com/ga.js</a></p>
