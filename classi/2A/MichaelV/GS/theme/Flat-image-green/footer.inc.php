	        ...
	        <section class="container">
	            ...
	            <div class="col-6">
			        <div class="text-right">
					    <div id="cms">
						    <a class="gs" href="http://get-simple.info/" target="_blank" title="GetSimple CMS"></a> 
						    <a class="ru" href="http://getsimplecms.ru/" target="_blank" title="GetSimple CMS  in Russian"></a>
					    </div>
			        </div>	
	            </div>	
                <div class="clearfix"></div>
